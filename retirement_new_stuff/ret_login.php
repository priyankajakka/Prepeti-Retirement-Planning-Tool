                    ...
                    <form method="POST" id="msform">
                        <fieldset>
                            <div class="form-card">
                                ...
                                <div style="font-size:11px">Don't have an account yet? <strong><a style="color:#72E9A5" href="http://localhost/~sjakka/RetirementToolwUI/create_acct.php">Sign up.</a></strong><br>
