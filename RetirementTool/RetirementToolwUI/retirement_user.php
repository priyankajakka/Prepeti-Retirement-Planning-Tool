                        ...
                        <ul class="navbar-nav ml-auto nav-tabs2" id="myTab">
                            ...
                            <li class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbar-default_dropdown_1">
                                    <a class="dropdown-item" href="http://localhost/~sjakka/RetirementTool/RetirementToolwUI/acct_settings.php">Account Settings</a>
                                    <div class="dropdown-divider"></div>
                                    <a class="dropdown-item" href="http://localhost/~sjakka/RetirementTool/RetirementToolwUI/ret_logout.php">Logout</a>
                                </div>
                            </li>
                        </ul>
                    </div>
                ...
                <div id="overview" class="tab-pane fade in active">
                    <nav>
                        <ol class="breadcrumb bg-transparent">
                            <li class="breadcrumb-item"><a href="http://localhost/~sjakka/RetirementTool/landingPage/index.html">Home</a></li>
                                ...
                                <div style="margin:0; padding:0;">
                                    <div class="">
                                        <div class="card h-100 mb-3 noBorder bg-transparent rounded-3">
                                            ...
                                            <div class="help-tip">
                                                <p>This table details the distribution of your investments among 401(k) and ETFs (whatever is outside your 401(k)).</p>
                                            </div>
                                            <br>
                    ...
                    <div class="row flex-center">
                        <div class="col-md-12">
                            <div class="bg-transparent card card-body h-100 mb-3 rounded-3">
                                <!--border-neon-->
                                <br>
                            ...
                            <div data-aos="fade-up" class="m-b-15">
                                <div style="margin:0; padding:0;">
                                    ...
                                    <div class="card h-100 mb-3 noBorder bg-transparent rounded-3">
                                        ...
                                        <div class="help-tip">
                                            <p>To match your recommended portfolio, here are some of the things you can work towards.</p>
                                        </div>
                                        <br>
                                        <table class="table table2Width" style="font-size: 16px;">
                                            <thead>
                    ...
                    <div class="row flex-center">
                        <div class="col-md-12">
                            <div class="col-md-12 card card-body h-100 mb-3 bg-transparent rounded-3">
                                ...
                                <br>
                                <div id="recChangesInvestments" class="card-text summary" style="font-size:20px"></div>
                            </div>
                        </div>
                    </div>
                ...
                <div id="menu2" class="tab-pane fade">
                    ...
                    <section>
                        <div class="row flex-center">
                            ...
                            <div class="col-md-6">
                                <img src="pictures/glammedUpPig.png" style="width:90%;" alt="" class="img-fluid" data-aos="fade-left">
                            </div>
                        </div>
                    </section>
                    <br>
...
<script src="js/ret_user.js"></script>
