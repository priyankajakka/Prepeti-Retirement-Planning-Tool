                    ...
                    <form name="create_acct_form" method="POST" id="msform">
                        <fieldset>
                            <div class="form-card">
                                ...
                                <div style="font-size:11px">Already have an account? <strong><a style="color:#72E9A5" href="http://localhost/~sjakka/RetirementTool/RetirementToolwUI/ret_login.php">Log in</a></strong><br>
