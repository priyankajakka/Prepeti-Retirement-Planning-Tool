      ...
      <div class="row flex-center">
        <div class="col-md-3">
          <div class="card card-body h-100 mb-3 border-neon bg-transparent rounded-3">
            <div data-aos="fade-up">
              ...
              <br>
              <div class="form-group">
                <label for="money" class="control-label">How much money do you need to live off each year?</label>
        ...
        <div class="col-md-9">
          <div class="bg-transparent card mb-3 rounded-3 blueBorder">
            <br>
            <!-- X is amount of money they live off of each year -->
            <h3 id="x_value" class="fw-bold" style="color:white">$X Equivalent Income in Retirement <br /></h3>
