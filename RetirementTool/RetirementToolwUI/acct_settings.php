...
if (isset($_POST["updateAcctInfo"])) {
    ...
    $new_portfolio = $_POST['new_portfolio'];
...
<head>
    ...
    <link rel="stylesheet" href="http://localhost/~sjakka/RetirementTool/RetirementToolwUI/css/retirementplswork.css">
</head>
...
<body>
    ...
    <script>
        ...
        function updatePortfolioCurrAge() {
            var retirement_age = <?php echo ($_SESSION['ret_age']); ?>;
            var current_age = document.getElementById("curr_age_change").value;
            var accum_years = retirement_age - current_age;
            var portfolio;

            console.log(retirement_age + " " + current_age + " " + accum_years);
            ...
            document.Form.new_portfolio.value = portfolio;
        }

        function updatePortfolioRetAge() {
            var current_age = <?php echo ($_SESSION['curr_age']); ?>;
            var retirement_age = document.getElementById("ret_age_change").value;
            var accum_years = retirement_age - current_age;
            var portfolio;
            ...
            document.Form3.new_portfolio.value = portfolio;
        }
    ...
    <section>
        ...
        <div class="container">
            ...
            <a href="http://localhost/~sjakka/RetirementTool/RetirementToolwUI/retirement_user.php" style="margin-left:10; color:white;">
                <button class="ButtonNeon" class="tablink">Return To Retirement Tool</button>
            </a>
            <br><br>
            <div>
                <div>
                    <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                        ...
                        <a class="nav-link" id="retirement-tab" data-toggle="pill" href="#retirement" role="tab" aria-controls="application" aria-selected="false">
                            Retirement Settings
                        </a>
                    </div>
                </div>
                <div class="tab-content p-4 p-md-5" id="v-pills-tabContent">
                    <div class="tab-pane fade show active" id="account" role="tabpanel" aria-labelledby="account-tab">
                        ...
                        <form name="Form" method="post" onsubmit="updatePortfolioCurrAge()">
                            <div class="row">
                                <div class="col-md-6">
                            ...
                            <input name="new_portfolio" type=hidden>
                            <button class="ButtonNeon" onclick="clearAccountInput()">Cancel</button>
                            <input class="ButtonNeon" name="updateAcctInfo" type="submit" value="Update">
                        </form>
                        <br><br>
                        <div style="color:white"><?php echo $acct_output; ?></div>
                    </div>
                    <div class="tab-pane fade" id="password" role="tabpanel" aria-labelledby="password-tab">
                        ...
                        <form name="Form2" method="post">
                            ...
                            <button class="ButtonNeon" onclick="clearPasswordInput()">Cancel</button>
                            <input class="ButtonNeon" name="updatePwdInfo" type="submit" value="Update">
                        </form>
                        <br><br>
                        <div style="color:white"><?php echo $pwd_output; ?></div>
                    </div>
                    <div class="tab-pane fade" id="retirement" role="tabpanel" aria-labelledby="retirement-tab">
                        <h3>Retirement Settings</h3>
                        <form name="Form3" method="post" onsubmit="updatePortfolioRetAge()">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                            ...
                            <button class="ButtonNeon" onclick="clearRetirementInput()">Cancel</button>
                            <input class="ButtonNeon" name="updateRetInfo" type="submit" value="Update">
                            <input name="new_portfolio" type=hidden>
                        </form>
                        <br><br>
                        <div style="color:white"><?php echo $ret_output; ?></div>
                    </div>
                </div>
            </div>
        </div>
